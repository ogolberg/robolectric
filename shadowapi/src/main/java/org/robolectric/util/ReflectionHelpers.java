...
public class ReflectionHelpers {
  ...
  public static <R> R callInstanceMethod(
    ...
    perfStatsCollector.incrementCount(
        String.format(
            ...
            instance.getClass().getSimpleName(), methodName));
    try {
  ...
  public static <R> R callInstanceMethod(
    ...
    perfStatsCollector.incrementCount(
        String.format(
            "ReflectionHelpers.callInstanceMethod-%s_%s", cl.getSimpleName(), methodName));
    try {
      final Class<?>[] classes = ClassParameter.getClasses(classParameters);
      final Object[] values = ClassParameter.getValues(classParameters);
  ...
  public static <R> R callStaticMethod(
    ...
    perfStatsCollector.incrementCount(
        String.format(
            "ReflectionHelpers.callStaticMethod-%s_%s", clazz.getSimpleName(), methodName));
    try {
  ...
  public static <R> R callConstructor(
    ...
    perfStatsCollector.incrementCount("ReflectionHelpers.callConstructor-" + clazz.getSimpleName());
    try {
      final Class<?>[] classes = ClassParameter.getClasses(classParameters);
      final Object[] values = ClassParameter.getValues(classParameters);
